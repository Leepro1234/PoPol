      ...
      if (group && this.hullabaloos.length) {
        ...
        while (i >= 0 && flag) {
          ...
          if (this.hullabaloos[i].text == hullabaloo.text && this.hullabaloos[i].status == hullabaloo.status) {
            ...
            hullabaloo.elem.css(this.options.offset.from, parseInt(parent.elem.css(this.options.offset.from)) + 80); //Height
            hullabaloo.elem.css(this.options.align, parseInt(parent.elem.css(this.options.align))); //Width
          }
          i--;
        }
      }
